...
export function normalizeConfig(options: unknown = {}): WebMcpRuntimeConfig {
    ...
    return {
        ...
        activeSearchTerm: nonEmptyString(source.activeSearchTerm),
        ...
        tools: {
            ...
            getListingFilters: booleanOption(tools.getListingFilters, true),
            filterProducts: booleanOption(tools.filterProducts, true),
            ...
            clearCart: booleanOption(tools.clearCart, true),
            selectVariant: booleanOption(tools.selectVariant, true),
